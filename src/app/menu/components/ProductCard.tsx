  ...
  return (
    <Box sx={{ 
      ...
      <Stack direction={{ xs: 'column', lg: 'row' }} spacing={4}>
        ...
        <Box sx={{ width: { lg: '25%' } }}>
          <Box sx={{ height: 250, bgcolor: '#f8f9fa', borderRadius: 3, overflow: 'hidden', border: '1px solid #f0f0f0', mb: 2 }}>
            <img 
          ...
          <Typography variant="h5" fontWeight="800" color="text.primary">{product.name}</Typography>
        ...
        <Box sx={{ flex: 1 }}>
          <Stack spacing={2.5}>
            <Stack direction="row" spacing={4}>
              <Box>
                <Typography variant="caption" color="text.secondary" fontWeight="bold" display="block" gutterBottom>TYPE</Typography>
                <Typography variant="body1" fontWeight="600" sx={{ color:'#3C2A21', textTransform: 'capitalize' }}>{product.type}</Typography>
              </Box>
              <Box>
                <Typography variant="caption" color="text.secondary" fontWeight="bold" display="block" gutterBottom>CATEGORY</Typography>
                <Typography variant="body1" fontWeight="600" sx={{  color:'#3C2A21', textTransform: 'capitalize' }}>{product.category || 'N/A'}</Typography>
              </Box>
              <Box>
                <Typography variant="caption" color="text.secondary" fontWeight="bold" display="block" gutterBottom>RATING</Typography>
